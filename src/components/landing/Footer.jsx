      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          {f.columns.map((col) => (
            <div key={col.title}>
              ...
              <ul className="space-y-2.5">
                {col.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-sm text-gray-500 hover:text-[#FF6B4A] transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="mt-14 pt-8 border-t border-gray-800/60 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="text-xs text-gray-600 hover:text-gray-400 transition-colors">{f.cookies}</a>
          </div>
        </div>
      </div>
    </footer>
