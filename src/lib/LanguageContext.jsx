...
export const T = {
  ...
  priorities:       { ko: "확인이 필요한 부분",      en: "Worth a Closer Look" },
  coachingGuide:    { ko: "AI 코칭 가이드",         en: "AI Coaching Guide" },
  coachingDisclaimer:{ ko: "이 운동은 참고용 예시이며, 실제 적용 전 전문가와 상담하시기 바랍니다.", en: "These exercises are for reference only. Please consult a professional before applying them." },
  bookCTA:          { ko: "1:1 상담 예약",          en: "Book a 1:1 Consultation" },
  bookDesc:         { ko: "PostureLab과 1:1 영상 상담을 예약할 수 있어요.", en: "Book a 1:1 video consultation with PostureLab." },
  ...
  measureGroupBasic:    { ko: "기본 자세 분석",   en: "Basic Posture Analysis" },
  measureGroupBasicSub: { ko: "사진 입력",        en: "Photo input" },
  measureGroupSport:    { ko: "종목별 동작 분석", en: "Sport Movement Analysis" },
  measureGroupSportSub: { ko: "동영상 업로드",    en: "Video upload" },
  measureCardsBasic: {
    ko: [
      { key: "spine",     label: "척추", desc: "체간 정렬 상태 확인" },
      { key: "shoulders", label: "어깨", desc: "좌우 대칭 확인" },
      { key: "pelvis",    label: "골반", desc: "수평 여부 확인" },
      { key: "knees",     label: "무릎", desc: "정렬 경향 확인" },
      { key: "feet",      label: "발",   desc: "기본 정렬 확인 (정밀 분석은 전용 장비 필요)" },
    ],
    en: [
      { key: "spine",     label: "Spine",     desc: "Check trunk alignment" },
      { key: "shoulders", label: "Shoulders", desc: "Check left/right symmetry" },
      { key: "pelvis",    label: "Pelvis",    desc: "Check level" },
      { key: "knees",     label: "Knees",     desc: "Check alignment tendency" },
      { key: "feet",      label: "Feet",      desc: "Basic alignment (precise analysis needs dedicated hardware)" },
    ],
  },
  measureCardsSport: {
    ko: [
  ...
  // ── Final CTA ───────────────────────────────────────────────────────────
  finalCTA: {
    ko: { title: "분석을 시작하세요", desc: "이제 AI 기반 동작 분석으로 자신의 움직임을 한눈에 살펴보세요.", start: "무료 체험 시작", demo: "데모 예약" },
    en: { title: "Start your analysis", desc: "Inspect your movement at a glance with AI-powered analysis.", start: "Start Free Trial", demo: "Book a Demo" },
  },

  // ── Posture compare ──────────────────────────────────────────────────────
  beforeAfter:       { ko: "비교", en: "Before & After" },
  compareTitle:      { ko: "PostureLab이 만드는 차이", en: "See the difference PostureLab makes" },
  compareDesc:       { ko: "같은 동작을 반복 촬영하면, 시간에 따른 변화를 한눈에 비교할 수 있습니다.", en: "Repeat the same movement across sessions to see how posture changes over time." },
