...
export const T = {
  ...
  // ── Measurement grid ─────────────────────────────────────────────────────
  measureEyebrow: { ko: "추적 항목", en: "What we track" },
  measureTitle:   { ko: "관절 하나하나, 프레임 하나하나.", en: "Every joint. Every frame." },
  measureDesc:    { ko: "야구·골프 동작에서 추적하는 관절 각도와 정렬 지표입니다.", en: "Joint angles and alignment metrics tracked across baseball and golf movements." },
  metricCards: {
    ko: [
      { key: "elbow",     label: "팔꿈치",         desc: "좌우 팔꿈치 각도 추적" },
      { key: "shoulder",  label: "견관절",         desc: "좌우 어깨 관절 각도 추적" },
      { key: "hip",       label: "고관절",         desc: "좌우 고관절 각도 추적" },
      { key: "knee",      label: "무릎",           desc: "좌우 무릎 각도 추적" },
      { key: "ankle",     label: "발목",           desc: "좌우 발목 각도 추적" },
      { key: "alignment", label: "정렬 지표",       desc: "어깨·골반·상체 기울기, 머리 전방/측방 위치" },
      { key: "swing",     label: "스윙 구간 분석",   desc: "골프 8단계 구간 자동 추천 (어드레스~피니시)" },
    ],
    en: [
      { key: "elbow",     label: "Elbow",          desc: "Left/right elbow angle tracking" },
      { key: "shoulder",  label: "Shoulder",       desc: "Left/right shoulder angle tracking" },
      { key: "hip",       label: "Hip",            desc: "Left/right hip angle tracking" },
      { key: "knee",      label: "Knee",           desc: "Left/right knee angle tracking" },
      { key: "ankle",     label: "Ankle",          desc: "Left/right ankle angle tracking" },
      { key: "alignment", label: "Alignment metrics", desc: "Shoulder/pelvis/trunk tilt, head forward & side position" },
      { key: "swing",     label: "Swing phase analysis", desc: "Golf 8-phase auto-suggested ranges (address → finish)" },
    ],
  },
  measureCats: {
    ko: [
      { key: "elbow", label: "팔꿈치", sub: "좌우 팔꿈치 각도 추적" },
      { key: "shoulder", label: "견관절", sub: "좌우 어깨 관절 각도 추적" },
      { key: "hip", label: "고관절", sub: "좌우 고관절 각도 추적" },
      { key: "knee", label: "무릎", sub: "좌우 무릎 각도 추적" },
      { key: "ankle", label: "발목", sub: "좌우 발목 각도 추적" },
      { key: "alignment", label: "정렬 지표", sub: "어깨·골반·상체 기울기, 머리 위치" },
      { key: "swing", label: "스윙 구간 분석", sub: "골프 8단계 구간 자동 추천 (어드레스~피니시)" },
    ],
    en: [
      { key: "elbow", label: "Elbow", sub: "Left/right elbow angle tracking" },
      { key: "shoulder", label: "Shoulder", sub: "Left/right shoulder angle tracking" },
      { key: "hip", label: "Hip", sub: "Left/right hip angle tracking" },
      { key: "knee", label: "Knee", sub: "Left/right knee angle tracking" },
      { key: "ankle", label: "Ankle", sub: "Left/right ankle angle tracking" },
      { key: "alignment", label: "Alignment metrics", sub: "Shoulder/pelvis/trunk tilt, head position" },
      { key: "swing", label: "Swing phase analysis", sub: "Golf 8-phase auto-suggested ranges (address → finish)" },
    ],
  },
